            ...
            <table class="table table-bordered datatable wrap" id="table-2">
                ...
                <tbody>
                    ...
                    $query = $conn->prepare(
                        ...
                        WHERE dj_sets.created_by='$user_id'

                        ORDER BY dj_sets.dj_set_episode asc
                    ...
                    ?>
                        ...
                        <tr>
                           ...
                           ?></td>
                            ...
                            <td>
                                <a href="edit_dj_sets.php?dj_set_id=<?php echo $result["id"] ?>" class="btn btn-default btn-sm btn-icon icon-left">
                                    <i class="entypo-pencil"></i>
                                    Edit
                                </a>

                                <!-- <a href="delete_dj_sets.php?id=<?php echo $result["id"] ?>" class="btn btn-danger btn-sm btn-icon icon-left">
